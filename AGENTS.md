...
These warnings come from real drift in this repository:
...
- Do not change Android tracking, GPS cadence, or push registration without reading `app/lib/nativeFieldTracking.js`.
- Preserve staging/production separation (`staging` vs `main`, separate Vercel projects, separate Supabase projects).
