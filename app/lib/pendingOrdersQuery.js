...
export const PENDING_ORDERS_SELECT = "id,order_number,customer_code,customer_name,salesman_code,salesman_name,created_by,created_at,updated_at,status,total_value";
