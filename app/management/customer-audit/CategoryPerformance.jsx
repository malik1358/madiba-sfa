...
import { monthName, numberFormat, qtyFormat } from "./lib/format";
        ...
        <table className="auditMatrix auditCategoryMatrixV3">
          <thead>
            <tr className="auditYearRow">
              <th rowSpan="2" className="auditCategoryHeader">
                Category
              </th>
              <th rowSpan="2" className="auditCategoryMetricHeader">
                Metric
              </th>
                              ...
                              <table className="auditItemMatrix">
                                <thead>
                                  <tr className="auditItemYearRow">
                                    <th rowSpan="2" className="auditItemNameHeader">
                                      Item
                                    </th>
                                    <th rowSpan="2" className="auditItemMetricHeader">
                                      Metric
                                    </th>

                                    {analytics.yearGroups.map((group) => (
                                      <th key={group.year} colSpan={group.months.length}>
                                        {group.year}
                                      </th>
                                    ))}

                                    <th rowSpan="2" className="auditItemTotalHeader">
                                      Total
                                    </th>

                                    <th rowSpan="2" className="auditRateHeader">
                                      Rate
                                    </th>

                                    <th rowSpan="2" className="auditOrderQtyHeader">
                                      Order Qty
                                    </th>
                                  </tr>
                                      ...
                                      <Fragment key={item.item_key}>
                                        <tr className="auditItemValueRow">
                                          ...
                                          <td rowSpan="2" className="auditRateCell">
                                            <span>{getPrice(priceList, item.item_code) ? `SAR ${getPrice(priceList, item.item_code).toFixed(2)}` : "—"}</span>
                                          </td>
