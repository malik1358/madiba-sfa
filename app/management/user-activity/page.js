...
const TEXT = {
  ...
  legendOrange: { en: "Orange — no transaction in last 45 min", ar: "برتقالي — لا معاملات خلال آخر 45 دقيقة" },
  legendGreen: { en: "Green — transaction in last 45 min", ar: "أخضر — معاملة خلال آخر 45 دقيقة" },
