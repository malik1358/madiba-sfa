...
This document was written from the repository at `main` (merge of PR #313, commit `e3e9150`). It does not describe a database that was queried live. Schema details come from `supabase/migrations/` and `sql/`.
