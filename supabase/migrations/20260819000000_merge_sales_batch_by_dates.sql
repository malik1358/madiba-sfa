...
REVOKE ALL ON FUNCTION public.merge_sales_batch_by_dates(bigint, date[]) FROM PUBLIC;
GRANT ALL ON FUNCTION public.merge_sales_batch_by_dates(bigint, date[]) TO service_role;

REVOKE ALL ON FUNCTION public.refresh_import_batch_stats(bigint) FROM PUBLIC;
GRANT ALL ON FUNCTION public.refresh_import_batch_stats(bigint) TO service_role;
