...
import { formatSalesOrderNumber, salesOrderNumberNeedsLiveLookup } from "../app/lib/salesOrderNumber.js";
...
test("formatSalesOrderNumber does not treat pending queue ids as the live number", () => {
  assert.equal(formatSalesOrderNumber({ id: "pending:8981a846-ca3" }), "pending:8981a846-ca3");
